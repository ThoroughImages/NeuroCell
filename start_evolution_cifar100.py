...
mean_tuple, std_tuple = (0.5071, 0.4867, 0.4408), (0.2675, 0.2565, 0.2761)
...
training_set = datasets.CIFAR100(root=root, train=True, download=True, transform=transform_train)
validation_set = datasets.CIFAR100(root=root, train=True, transform=transform_test)
test_set = datasets.CIFAR100(root=root, train=False, transform=transform_test)
...
e = Evo(base_epochs=63, mutation_epochs=15, ft_epochs=63, lr=0.01, init_size=INIT_SIZE)
# e = Evo(base_epochs=1, mutation_epochs=1, ft_epochs=1)

base_model_tuple = create_base_model(num_cells=3, input_dim=32, num_classes=100, dropout_conv=0.7, dropout_fc=0.5)
